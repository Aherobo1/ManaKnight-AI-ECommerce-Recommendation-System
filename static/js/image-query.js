...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const naturalLanguageResponse = document.getElementById(
  ...
  function hideLoading() {
    ...
    uploadBtn.disabled = false;
    uploadBtn.innerHTML =
      '<i class="fas fa-magic me-2"></i>Extract Text & Search';
  }
